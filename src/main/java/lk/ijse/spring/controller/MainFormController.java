...
public class MainFormController implements Initializable { 
    ...
    /**
     * Initializes the lk.ijse.spring.controller class.
     */
        ...
        if (event.getSource() instanceof ImageView){
            ...
            switch(icon.getId()){
                case "imgCustomer":
                    ...
                    lblDescription.setText("Click to add, edit, delete, search or lk.ijse.spring.view customers");
                    break;
                case "imgItem":
                    lblMenu.setText("Manage Items");
                    lblDescription.setText("Click to add, edit, delete, search or lk.ijse.spring.view items");
                    break;
                case "imgOrder":
